...
public class BuyCSItemHandler extends AbstractMaplePacketHandler {
    ...
    public void handlePacket(SeekableLittleEndianAccessor slea, MapleClient c) {
        ...
        if (action == 3) {
            ...
            if(itemID == 1812006 || itemID == 5220000 || itemID >= 5211004 && itemID <= 5211008 || itemID >= 5211009 && itemID <= 5211013 || itemID >= 5211014 && itemID <= 5211018 || itemID >= 5211037 && itemID <= 5211049 || itemID == 5140000){
                c.getSession().write(MaplePacketCreator.enableActions());
                c.getPlayer().dropMessage(1, "You may not purchase this item."); //disabled items <-- whoever wrote this is disabled NICE FUCKING ENGLISH LMAO (HEY FUCK YOU PUDE! YOU HAVE NO PROOF NOW)
                return;
            }
