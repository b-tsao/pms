...
function action(mode, type, selection) {		
	...
	if (status == 0 && mode == 1) {
		...
		if (selectedType == 0) { //What's a stim?
			...
			var weapon = new Array ("Dragon Revolver#k - Lv. 110 Gun#b","Dragon Slash Claw#k - Lv. 110 Knuckle#b");
			for (var i = 0; i < weapon.length; i++){
				selStr += "\r\n#L" + i + "# " + weapon[i] + "#l";
			}
			cm.sendSimple(selStr);
		...
		if (selectedType == 1){ //warrior weapon
			...
			var itemSet = new Array(1492013,1482013);
			var matSet = new Array(new Array(1492012,4000244,4000245,4005002,4005000),new Array(1482012,4000244,4000245,4005000,4005002));
			var matQtySet = new Array(new Array(1,20,25,5,3),new Array(1,20,25,5,3));
			var costSet = new Array(120000,120000);
			item = itemSet[selectedItem];
			mats = matSet[selectedItem];
			matQty = matQtySet[selectedItem];
