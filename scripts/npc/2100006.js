...
var mhair = Array(30320, 30330, 30150, 30310, 30170, 30180, 30820, 30410, 30460);
var fhair = Array(31400, 31090, 31190, 31620, 31040, 31420, 31440, 31330, 31340);
var hairnew = Array();
...
function action(mode, type, selection) {
	if (mode == -1) {
		...
		if (mode == 1)
			...
			status--;
		if (status == 0) {
			cm.sendSimple("Hello! I'm Mazra, the pride and joy of Ariant's beauty salon! If you have either #b#t5150027##k or #b#t5151022##k, why don't you let me take care of the rest? Decide what you want to do with your hair...\r\n#L0#I want to buy a coupon!#l\r\n#L1#Haircut: #i5150027##t5150027##l\r\n#L2#Dye your hair: #i5151022##t5151022##l");						
		} else if (status == 1) {
			if (selection == 0) {
				beauty = 0;
