	...
	if (mode == -1) {
		...
		if (status == 0) {
			if (cm.getJob().equals(net.sf.odinms.client.MapleJob.BEGINNER)) {
				...
				if (cm.getLevel() >= 30 
				...
				} else if (cm.getQuestStatus(100100).equals(MapleQuestStatus.Status.STARTED) && cm.getJob().equals(MapleJob.FIGHTER) || cm.getJob().equals(MapleJob.SPEARMAN) || cm.getJob().equals(MapleJob.PAGE)) {
					if (cm.getQuestStatus(100101).equals(MapleQuestStatus.Status.COMPLETED) && (cm.haveItem(4031057))) {
						 cm.sendOk("Alright, now bring #b#i4031057##t4031057##k to #bTylus#k.");
                    ...
                    cm.gainItem(4031057)
                        ...
                        cm.sendOk("I was expecting you. A few days ago, I heard about you from #b#p2020008##k in Ossyria. Well... I'd like to test your strength. There is a secret passage near the ant tunnel. Nobody but you can go into that passage. If you go into the passage, you will meet my other self. Beat him and bring the #b#t4031059##k to me.");
