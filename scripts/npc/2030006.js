...
var qChars = new Array ("Q1: What EXP is needed to level up from Level 1 to Level 2?#10#12#15#20#3",
	...
	"Q1: At 1st Job Advancement, Which job bases in Henesys?#Warrior#Bowman#Magician#Thief#2");
var qItems = new Array( "Q2: Which of the following monster drops is correct?#Jr Wraith - Wraith Headband#Stirge - Stirge Wing#Slime - Squishy Bubble#Pig - Ribbon#2",
	"Q2: Which monster drop is incorrect?#Ribbon Pig - Pig Ribbon#Slime - Slime Bubble#Snail - Snail Shell#Axe Stump - Tree Branch#4",
	"Q2: What version are you playing?#v65#v83#v75#v62#4",
	"Q2: Which potion restores 50% Hp & Mp?#Elixir#Power Elixir#Ginger Ale#Cider#1", 
	"Q2: What server are you playing?#NidoMS#OdinMS#MapleVintage#MapleStory2#3");
...
var qQuests = new Array("Q4: Which Quest requires you to kill 50 Stumps?#Stump Horror Story#Pio's Collecting#Johns Flower Basket#Jane the Alchemist#1",
	"Q4: Which Quest can be repeated?#Finding The Maple History Books#I'm Bored#Mrs Ming Ming#Glass Slipper#4",
	"Q4: Which is not a 2nd Job advancement?#Mage#Fighter#Crossbowman#Assassin#1",
	"Q4: Which quest requires you to collect eggs?#Mason#Nemi#Alcaster#Arwin#2",
	"Q4: Which 2nd job uses throwing stars and a claw?#Bandit#Assassin#Hunter#Cleric#2",
	"Q4: What colour is a LUK Crystal?#Pink#Red#Purple#Green#1");
