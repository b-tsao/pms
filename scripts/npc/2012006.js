...
var mapid = new Array(101000000, 200000110,200000120,200000130,200000140,200000150);
var platform = new Array("Skip straight to Ellinia", "The platform to the ship that heads to Ellinia","The platform to the ship that heads to Ludibrium","The platform to the ship that heads to Leafre","The platform to the ship that heads to Mu Lung","The platform to the ship that heads to Ariant");
...
function action(mode, type, selection) {
	if (mode == -1) {
		...
		if(status == 0) {
			...
			select = selection;
			cm.sendYesNo("Would you like to go?");
		} else if(status == 2) {
