//Singapore Gachapon (LOL GET SCAMMED KIDS ITS ALMOST SAME AS SHOWA)
...
function action(mode, type, selection) {
	if (mode == -1) {
		...
		if (cm.haveItem(5220000) && cm.canHold(1000000) && cm.canHold(2000000) && cm.canHold(3990000) && cm.canHold(4000000)) {
			...
			cm.gainItem(1102054, 1, true, true);
			}	
			else if (itemchance == 88) {
			cm.gainItem(1102055, 1, true, true);
			}
			else if (itemchance == 89) {
			cm.gainItem(1102056, 1, true, true);
			}
			else if (itemchance == 90) {
			cm.gainItem(1102053, 1, true, true);
			}
