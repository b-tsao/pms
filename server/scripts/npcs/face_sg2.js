/**
 * Noel: Plastic Surgery Asistant (NPC 9270024)
 * CBD Singapore (Map 540000000)
 *
 * Allows face change for Singapore reg Ticket
 *
 * @author joemama
 */
...
let selection = npc.askYesNo("If you use the regular coupon, your face may transform into a random new look...do you still want to do it using #b#t5152037##k?");
if (selection == 1) {
	if (player.hasItem(5152037, 1)) {
		player.loseItem(5152037, 1);
