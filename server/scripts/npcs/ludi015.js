...
if (player.hasItem(4001020, 1)) {
	...
	let map;
	if (selection == 0) {
		prompt = "You can use #b#t4001020##k to activate #bSecond Eos Rock#k. Will you teleport to #bFirst Eos Rock#k at the 100th Floor?";
		map = 221024400;
	} else if (selection == 1) {
		prompt = "You can use #b#t4001020##k to activate #bSecond Eos Rock#k. Will you teleport to #bThird Eos Rock#k at the 41st Floor?";
		map = 221021700;
	}
